...
from detectron2.projects.rise import add_rise_config, build_detection_train_loader, build_detection_test_loader 
from detectron2.projects.rise.data import (
    YTVISDatasetMapper,ARMBENCHDatasetMapper, YTVISEvaluator,ARMBENCHEvaluator, get_detection_dataset_dicts,DetrDatasetMapper,
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        elif evaluator_type == "armbench":
            print("evaluating ARMBENCH!")
            evaluator_list.append(ARMBENCHEvaluator(dataset_name, cfg, True, output_folder))
            #evaluator_list.append(COCOEvaluator(dataset_name, cfg, True, output_folder))
    ...
    @classmethod
    def build_train_loader_u(cls, cfg):
        dataset_name = cfg.DATASETS.TRAIN[0]+'_unlabeled'
        ...
        elif dataset_name.startswith('armbench'):
            mapper = ARMBENCHDatasetMapper(cfg, is_train=True)
        else:
            mapper = ARMBENCHDatasetMapper(cfg, is_train=True)
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        if dataset_name.startswith('coco'):
            ...
            mapper = ARMBENCHDatasetMapper(cfg, is_train=False)
        else: #add more datasets
            mapper = ARMBENCHDatasetMapper(cfg, is_train=False)
